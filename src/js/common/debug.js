...
var DBG = {
	...
	write : function(txt){
		...
		if (!window.dbgwnd) {
			...
			window.dbgwnd.document.write('<html><head></head><body style="background-color:black"><div id="main" style="color:white;font-size:12px;font-family:Courier New;"></div></body></html>');
		}
